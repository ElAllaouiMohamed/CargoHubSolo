...
def test_add_and_delete_item_group(api_data):
    ...
    delete_response = requests.delete(
        f"{url}/item_groups/{new_item_group['id']}", headers={"API_KEY": api_key}
    )
...
def test_update_item_group(api_data):
    ...
    put_response = requests.put(
        f"{url}/item_groups/{item_group_id}",
...
def test_get_item_group_invalid_id(api_data):
    ...
    response = requests.get(
        f"{url}/item_groups/{invalid_id}", headers={"API_KEY": api_key}
    )
...
def test_get_item_group_empty_id(api_data):
    ...
    response = requests.get(
        f"{url}/item_groups/{empty_id}", headers={"API_KEY": api_key}
    )
...
def test_get_item_group_negative_id(api_data):
    ...
    response = requests.get(
        f"{url}/item_groups/{negative_id}", headers={"API_KEY": api_key}
    )
