...
def test_update_inventory(api_data):
    ...
    put_response = requests.put(
        f"{url}/inventories/{inventory_id}",
...
def test_get_inventory_invalid_id(api_data):
    ...
    response = requests.get(
        f"{url}/inventories/{invalid_id}", headers={"API_KEY": api_key}
    )
...
def test_get_inventory_empty_id(api_data):
    ...
    response = requests.get(
        f"{url}/inventories/{empty_id}", headers={"API_KEY": api_key}
    )
...
def test_get_inventory_negative_id(api_data):
    ...
    response = requests.get(
        f"{url}/inventories/{negative_id}", headers={"API_KEY": api_key}
    )
